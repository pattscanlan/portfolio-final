  ...
  const featuredCaseStudies = [
    {
      ...
      imageUrl: 'https://placehold.co/600x400/1e293b/ffffff?text=SAR+Data+Viz',
    ...
    },
    {
      ...
      details: {
        ...
        visuals: [
            { type: 'image', url: 'https://i.imgur.com/3Z8YQ4j.png', caption: 'High-fidelity mockups showing the key user flows, from reporting an inaccuracy to the gamified contributor profile.' }
        ],
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="md:w-2/3">
                ...
                <div className="flex space-x-4">
                  <a href="https://www.linkedin.com/in/pattscanlan/" className="text-slate-400 hover:text-blue-400"><Linkedin size={24} /></a>
