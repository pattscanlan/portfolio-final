    ...
    },
    {
      ...
      details: {
        ...
        process: [
          ...
          { title: "Prototyping & Validation", description: "I created a prototype of the user flow, from rating a trail's accuracy post-hike to being prompted to verify a known issue on the trail. I validated the concept with prototype testers, who found the system motivating and straightforward." }
        ],
        visuals: [
  ...
  const otherCaseStudies = [
    {
      ...
      details: {
        ...
        visuals: [
            { type: 'image', url: process.env.PUBLIC_URL + '/TCJourneyMap.png', caption: 'The Telecommunicator Journey Map for an unresponsive user, highlighting mindsets, pain points, and opportunities across the incident lifecycle.' }
        ],
    ...
    },
    {
      ...
      imageUrl: process.env.PUBLIC_URL + '/NutriNeedsIntro.png',
